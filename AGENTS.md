...
Para instrucciones detalladas y ejemplos de código, consultar el skill `spring-expert` en [`.agents/skills/spring-expert/SKILL.md`](.agents/skills/spring-expert/SKILL.md).
